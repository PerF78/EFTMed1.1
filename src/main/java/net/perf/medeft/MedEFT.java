...
public class MedEFT {
    ...
    private void handleFireDamage(Player player, float damage) {
        ...
        float currentHealth = player.getPersistentData().getFloat("body_health");
        if (currentHealth == 0) {
            updateLimbHealthWithArmor(player, "head_health", 52.0f);
        }
    ...
    private void handleExplosionDamage(Player player, float damage, DamageSource source) {
        ...
        if (yDifference > 1.5) {
            updateLimbHealthWithArmor(player, "head_health", damage * proximityFactor * 2.0f * multiplier);
            updateLimbHealthWithArmor(player, "body_health", damage * proximityFactor * 0.5f * multiplier);
            updateLimbHealthWithArmor(player, "arms_health", damage * proximityFactor * 0.3f * multiplier);
            updateLimbHealthWithArmor(player, "legs_health", damage * proximityFactor * 0.1f * multiplier);
        } else {
            updateLimbHealthWithArmor(player, "legs_health", damage * proximityFactor * 0.5f * multiplier);
            updateLimbHealthWithArmor(player, "body_health", damage * proximityFactor * 0.3f * multiplier);
            updateLimbHealthWithArmor(player, "arms_health", damage * proximityFactor * 0.4f * multiplier);
            updateLimbHealthWithArmor(player, "head_health", damage * proximityFactor * 0.2f * multiplier);
        }
